...
//SDK 内置的服务IP 用于解析域名使用
NSString *const ALICLOUD_HTTPDNS_DEFAULT_SERVER_IP = @"203.107.1.1";
...
+ (void)configureServerIPsAndResetActivatedIPTime {
    ...
    ALICLOUD_HTTPDNS_SERVER_IPV6_LIST = @[ALICLOUD_HTTPDNS_SCHEDULE_CENTER_REQUEST_HOST_IPV6_2];
