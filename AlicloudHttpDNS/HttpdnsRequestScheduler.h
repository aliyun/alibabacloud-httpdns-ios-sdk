...
FOUNDATION_EXTERN NSArray *ALICLOUD_HTTPDNS_SERVER_IPV6_LIST;
FOUNDATION_EXTERN NSTimeInterval ALICLOUD_HTTPDNS_RESET_ACTIVATED_SERVER_IP_TIME_HOURS;
FOUNDATION_EXTERN NSTimeInterval serverDisableStateLocalCacheTimeInterval;
FOUNDATION_EXTERN NSString *ALICLOUD_HTTPDNS_SERVER_IP_REGION;
